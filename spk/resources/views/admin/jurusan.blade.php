...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="nama_jurusan" placeholder="Nama Jurusan" id="nama_jurusan" required>
</div>
@endsection
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#data').on('click','.edit',function(){
          ...
          $('#id').val($(this).data('id'));
          $('#nama_jurusan').val($(this).data('nama_jurusan'));
